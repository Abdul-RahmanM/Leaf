...
const Header = () => {
    return (
        <div className="header">
            <div className="logo">
                <img src="https://media.istockphoto.com/id/1337757821/vector/watercolor-green-leaf-logo.jpg?s=612x612&w=0&k=20&c=zz70lOyGNfZ_dc-nl5miMg1qLrWkw-tnnRTKJpjgkB4=" className="logo-pic"/>
            </div>
